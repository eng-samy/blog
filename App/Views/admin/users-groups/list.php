                  ...
                  <table class="table table-bordered">
                    ...
                    <?php foreach ($users_groups AS $users_group) { ?>
                        <tr>
                          ...
                          <td>
                            <button type="button" data-target="<?php echo url('admin/users-groups/edit/' . $users_group->id) ?>" data-modal-target="#edit-users-group-<?php echo $users_group->id; ?>" class="btn btn-info open-popup">
                                Edit
