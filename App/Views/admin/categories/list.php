                  ...
                  <table class="table table-bordered">
                    ...
                    <?php foreach ($categories AS $category) { ?>
                        <tr>
                          ...
                          <td>
                            <button type="button" data-target="<?php echo url('admin/categories/edit/' . $category->id) ?>" data-modal-target="#edit-category-<?php echo $category->id; ?>" class="btn btn-info open-popup">
                                Edit
